...
const gradients = [
  ...
  { gradient: "linear-gradient(135deg, #EFF3F4 0%, #0F0C41 100%)", dark: false },
  { gradient: "linear-gradient(135deg, #0F0C41 0%, #EFF3F4 100%)", dark: false },
  // Lighter variations
  { gradient: "linear-gradient(135deg, #1D9BF0 0%, #0F0C41 50%, #EFF3F4 100%)", dark: false },
  { gradient: "linear-gradient(135deg, #EFF3F4 0%, #8B98A5 50%, #1D9BF0 100%)", dark: false },
];
